...
export function isOpenAPIV3(spec: unknown): spec is OpenAPIV3.Document {
  return (
    ...
    spec !== null &&
    'openapi' in spec &&
    typeof (spec as OpenAPIV3.Document).openapi === 'string' &&
    (spec as OpenAPIV3.Document).openapi.startsWith('3.')
  );
}

export function isOpenAPIV3_1(spec: unknown): spec is OpenAPIV3_1.Document {
  return (
    typeof spec === 'object' &&
    spec !== null &&
    'openapi' in spec &&
    typeof (spec as OpenAPIV3_1.Document).openapi === 'string' &&
    (spec as OpenAPIV3_1.Document).openapi.startsWith('3.1')
  );
}
